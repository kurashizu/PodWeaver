...
DEFAULT_INPUT = os.path.join(os.path.dirname(__file__) or ".", "script.txt")
DEFAULT_OUTDIR = os.path.join(os.path.dirname(__file__) or ".", "segments")
